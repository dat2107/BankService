...
<div class="max-w-5xl mx-auto mt-10 bg-white shadow-md rounded-lg p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold">User Levels List</h2>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full border border-gray-200 text-gray-700">
            ...
            <tr>
                ...
                <th class="px-4 py-2 border">Level Name</th>
                <th class="px-4 py-2 border">Card Limit</th>
                <th class="px-4 py-2 border">Daily Transfer Limit</th>
...
<div id="userLevelModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg w-96 p-6">
        <h2 id="modalTitle" class="text-xl font-bold mb-4">Add User Level</h2>
        ...
        <form id="userLevelForm" onsubmit="return false;" class="space-y-4" >
            ...
            <div>
                <label class="block font-semibold mb-1">Card Limit</label>
                <input type="number" name="cardLimit" id="cardLimit" required
                       class="w-full border rounded px-3 py-2"/>
            </div>

            <div>
                <label class="block font-semibold mb-1">Daily Transfer Limit</label>
...
<script src="/assets/js/userlevel.js"></script>
</body>
</html>
